...
`;o("footer-copyright",{styles:A,template:S});var $=`
  :host {
...
`;o("section-footer",{styles:$,template:P});var H=`
    section {
        margin-inline: auto;
        width: 80%;
    }
...
`;o("section-credits-intro",{styles:H,template:I});var T=`
  :host {
    --local-width: 3rem;
    --local-height: auto;
...
`,O=["src","alt"],R=()=>'<img data-forward width="200" height="200"/>';o("app-icon",{attrs:O,styles:T,template:R});var _=`
  :host {
    display: flex;
    align-items: center;
    justify-content: space-between;
...
`,C={icon:String,alt:String,url:String,name:String},E=({icon:e,alt:n,url:i,name:s})=>`
...
`;o("section-creators-list",{styles:B,template:N});
