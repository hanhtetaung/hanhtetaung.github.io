...
`,b=["width","height","src","alt"],w=()=>"<img data-forward />";o("app-logo",{attrs:b,styles:v,template:w});var a="769px",D="992px";var y=`
  :host {
    display: block;
  }
...
`;o("section-header",{template:k,styles:y});var x=[{href:"/",name:"Home"},{href:"/about",name:"About"},{href:"/credits",name:"Credits"},{href:"/hire-me",name:"Hire Me"},{href:"/thank-you",name:"Thank You"},{href:"/capabilities/design-system",name:"Design System"},{href:"/capabilities/user-interfaces",name:"User Interfaces"},{href:"/capabilities/web-interfaces",name:"Web Interfaces"},{href:"/work/terra",name:"Terra"},{href:"/work/bamboo",name:"Bamboo"},{href:"/work/mmo",name:"MMO"},{href:"/work/au-van",name:"AU Van"},{href:"/work/portfolio",name:"Portfolio"},{href:"/work/sks-solar",name:"SKS Solar"},{href:"/writings/foundation-building-interfaces-at-scale",name:"Foundation"}],A=`
  :host {
...
`,z={name:String,img:String,alt:String},B=({name:e="Name",img:t="/assets/images/coming-soon.jpg",alt:n="Coming Soon"})=>`
  <section>
      <div>
        <hgroup>
          <p>Coming Soon</p>
...
`;o("section-coming-soon-intro",{props:z,styles:T,template:B});var I=`
  :host {
    display: block;
  }
`,M=`
  <section-coming-soon-intro
    props='{"name":"AU Van"}'
  ></section-coming-soon-intro>
`;o("section-au-van-intro",{styles:I,template:M});
