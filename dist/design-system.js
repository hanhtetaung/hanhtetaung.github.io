...
`;e("section-footer",{styles:H,template:T});var L=`
  :host {
    --local-width: 5rem;
    --local-heigth: auto;
...
`,O=["width","height","src","alt"],E=()=>"<img data-forward />";e("app-image",{attrs:O,styles:L,template:E});var I=`
  :host {
    --local-width: 3rem;
    --local-height: auto;
...
`,N=["src","alt"],P=()=>'<img data-forward width="200" height="200"/>';e("app-icon",{attrs:N,styles:I,template:P});var j=`
   section {
        margin-inline: auto;
        width: 80%;
        display: flex;
...
`,_={name:String,img:String,alt:String},B=({name:t="Name",img:i="/assets/images/coming-soon.jpg",alt:a="Coming Soon"})=>`
  <section>
      <div>
        <hgroup>
          <p>Coming Soon</p>
...
`;e("section-coming-soon-intro",{props:_,styles:j,template:B});var D=`
  :host {
    display: block;
  }
...
`;e("section-design-system-intro",{styles:D,template:W});var F=`
  :host {
    display: flex;
    align-items: center;
    width: fit-content;
...
`,M={name:String,img:String,alt:String},U=({name:t,img:i="",alt:a=""})=>`
    <h2>${t}</h2>
    <img
        src=${i}
        alt=${a}
        ...
        width="76"
    />
`;e("section-title",{props:M,styles:F,template:U});var G=`
  :host {
    display: block;
  }
...
`;e("section-design-system-workflow",{styles:G,template:J});var K=`
  :host {
    --local-bg: var(--color-secondary);
    --local-color: var(--color-bg-primary);
    --local-border: none;
